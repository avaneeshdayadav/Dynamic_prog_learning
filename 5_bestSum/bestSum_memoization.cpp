// bestSum Mentos Jindagi (memoization)
...
vector<int> bestSum(int arr[], int n, int targetSum, map<int,vector<int>> &memo)
{
    ...
    memo[targetSum] = shortestComb; // Storing shortest combination Possible for this targetSum in map or if not Possible storing null (i.e capacity=0) vector.
